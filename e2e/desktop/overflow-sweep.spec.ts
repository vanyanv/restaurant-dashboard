 ...
 * was 777px on both surfaces and only crossed the line on one. A defect that
 * is invisible at 1440px is still the same defect.
 *
 * The fidelity gate compares landmarks and eighteen computed properties on
 * each; none of them is "does this page fit". A table two columns too wide, a
 * strip whose track count exceeds the viewport, a long unbroken vendor name —
 * each one matches its design perfectly and each one pushes the body sideways.
 *
