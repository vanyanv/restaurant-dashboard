      ...
      {data.events.length === 0 ? (
        ...
        <div>
          ...
          {data.events.map((e) => (
            <div
              key={e.id}
              className="grid grid-cols-[100px_1fr_120px_120px_100px] gap-4 items-center px-5 py-2 border-t border-[var(--hairline)] hover:bg-[var(--row-hover-bg)] transition-colors"
            >
