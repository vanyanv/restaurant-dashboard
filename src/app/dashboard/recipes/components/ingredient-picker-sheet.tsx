...
export function IngredientPickerSheet({
  ...
  return createPortal(
    ...
    >
      ...
      {/* Drawer */}
      <div
        className="absolute right-0 top-0 flex h-full w-full max-w-[680px] flex-col border-l border-[var(--hairline-bold)] bg-[var(--paper)] animate-in slide-in-from-right duration-300"
        style={{
          backgroundImage:
