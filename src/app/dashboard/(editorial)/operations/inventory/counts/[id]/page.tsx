          ...
          {data.lines.map((line) => {
            ...
            return (
              <div
                ...
                className="grid grid-cols-[1fr_100px_100px_100px_120px_120px] gap-4 items-center px-5 py-2 border-t border-[var(--hairline)] hover:bg-[var(--row-hover-bg)] transition-colors"
              >
                <div>
