...
import { CounterPeopleClient } from "./counter-people-client"
...
export default async function Page() {
  ...
  return (
    <>
      <CounterPeopleClient sections={sections} />
      <span hidden data-perf-ready="/dashboard/admin/monitoring/people" />
    </>
  )
}
