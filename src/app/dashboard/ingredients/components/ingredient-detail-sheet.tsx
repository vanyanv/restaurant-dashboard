...
export function IngredientDetailSheet({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className="absolute right-0 top-0 flex h-full w-full max-w-[640px] flex-col border-l border-[var(--hairline-bold)] bg-[var(--paper)] animate-in slide-in-from-right duration-300"
        style={{
          backgroundImage:
