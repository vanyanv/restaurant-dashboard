...
export { RankBars, type RankBar } from "./surface/rank-bars"
export { Matrix, type MatrixPoint, type MatrixSpec, type MenuQuadrant } from "./surface/matrix"
export { Donut, type DonutProps, type DonutSlice } from "./surface/donut"
...
export { Filters, Toggles, type FilterToggle } from "./surface/filters"
...
/* The week ahead's three. `Attribution` draws the TreeSHAP waterfall that
   `ml/models/attribution.py` has been writing since 2026-08-19 with nothing to
   display it; `RunOut` is the section the prototype never had. */
export {
  Attribution,
  Sureness,
  Provenance,
...
} from "./surface/attribution"
export { RunOut, RunOutKey, type RunOutBarRow } from "./surface/run-out"
